...
function sendOrderWhatsApp() {
    ...
    const phoneNumber = "+201140641705";
...
function createFooter(){
    ...
    <div class="col">
      <img src="images/WhatsApp Image 2024-08-20 at 10.23.47 PM.jpeg" class="logo-footer" style="border-radius: 50%;">
      <p class="portfolio-p">
      كل اللي تفكر فيه هتلاقيه عندنا 
      لأن كل حاجة في حياتك بتأثر على صحتك ضروري كل أكل أو شرب تتأكد أنه آمن على صحتك، و ده اللي بنقدمهولك🤍👌
       اعلي جودة في مصر بأقل الأسعار 🤍
      </p>
    </div>
    <div class="col">
      ...
      <p class="email-id"> <i class="fa-solid fa-envelope" style="margin-left:10px"></i>Kmgg246@gmail.com</p>
      <h4 class="phone-number"> <i class="fa-solid fa-phone" style="margin-left:10px"></i>+20 1140641705</h4>
    </div>
    <div class="col">
  ...
  <hr class="footer-hr">
  <p class="copyright"><a href="">FireApps </a> All rights reserved © </p>`;
...
document.addEventListener('DOMContentLoaded', function() {
    const headerHTML = `
      <header>
        <div class="navbar">
          <div class="logo"><a href="index.html">KM.EG Pottrey</a></div>
          <ul class="links">
